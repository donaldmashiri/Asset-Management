            ...
            <div class="col-xl-112 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-white">Active Assets</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM assets WHERE status = 'active'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<h1 class='alert alert-danger'>You Have No Active assets</h1>";
                            }
                            ?>
